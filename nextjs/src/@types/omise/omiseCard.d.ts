import { Locale, OtherPaymentMethods, YesOrNo } from "./utils";
...
export declare type OmiseCardConfigure = (
  config: OmiseCardConfiguration
) => void;
export interface OmiseCardConfiguration {
  publicKey: string;
}
export declare type OmiseCardConfigureButton = (
