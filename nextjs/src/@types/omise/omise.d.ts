...
export declare type OmiseCreateToken = (
  type: string,
...
export declare type OmiseCreateTokenCallback = (
  statusCode: HttpStatusCode,
  response: OmiseCreateTokenResponse
) => void;
export declare type OmiseCreateTokenResponse = OmiseCreateResponseSuccessful &
  OmiseResponseFailure;
...
export declare type OmiseCreateSource = (
  type: Payment,
  sourceParameters: OmiseCreateSourceParameters,
  callback: (
    statusCode: HttpStatusCode,
    response: OmiseCreateSourceCallbackSuccessful
  ) => void
) => void;
...
export declare type OmiseCreateSourceCallback =
  OmiseCreateSourceCallbackSuccessful & OmiseResponseFailure;
